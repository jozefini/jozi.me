<script lang="ts">
	...
	const css = {
		...
		dot: 'dot text-black dark:text-white absolute bottom-0 left-1/2 w-1.5 h-1.5 rounded-full bg-current in-flex -translate-x-1/2 transition-[background_transform] duration-[150ms_300ms]',

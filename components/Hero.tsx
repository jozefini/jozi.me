...
const css = {
  ...
  details: '',
  subtitle: 'text-xs lg:text-base text-white/50 uppercase font-medium tracking-widest mb-8',
    ...
    <section className={cn(css.wrapper, className)}>
      ...
      <div className={css.inner}>
        <div className={css.details}>
          <div className={css.subtitle}>Jozefin Bashaj</div>
          ...
          <div className={css.action}>
            <Link className={css.btn} href={portfolioPath}>
